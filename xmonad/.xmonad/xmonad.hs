...
ws8Msgs    = "8 \xf27a"
ws9Mail    = "9 \xf0e0"
myWorkspaces = [ ws1Term, ws2Browser, ws3, ws4, ws5, ws6, ws7, ws8Msgs, ws9Mail ]
...
rofiCommand = "rofi -matching fuzzy -modi combi -show combi -combi-modi run,drun,window"
...
projects = 
    ...
    , Project { projectName      = ws2Browser
              , projectDirectory = "~/"
              , projectStartHook = Just $ do spawn myBrowser
              }
    , Project { projectName      = ws8Msgs
              , projectDirectory = "~/"
...
myStartupHook = do  -- ewmhDesktopsStartup
...
myLogHook dbus = def 
    ...
    , ppSep = " :: "
    , ppTitle = foreground colorGreen . shorten 70
    }
  where
