var electronTracker = {
  ...
  sendRequest: function(data, callback) {
    ...
    if(window.process && window.pm) {
      postData += pm.getVersion();
    } else {
      postData += chrome.runtime.getManifest()['version'];
    }
    postData += "&cd=" + this.screenName + "&sr=" + this.screenRes + "&vp=" + this.viewport;
