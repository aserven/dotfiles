ace.define("hoverlink", ["require","exports","module"], function(require, exports, module) {
    ...
    (function(){
        ...
        this.getMatchAround = function(regExp, string, col) {
            ...
            if(match) {
                var strIndex = oldString.indexOf(match.value);
                if(strIndex>0 && oldString[strIndex-1]=='<') {
                    return null;
                }
            }
            return match;
