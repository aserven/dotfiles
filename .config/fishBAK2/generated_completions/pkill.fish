...
complete -c pkill -s d -l delimiter --description 'Sets the string used to delimit each process ID… [See Man Page]'
...
complete -c pkill -s a -l list-full --description 'List the full command line as well as the process ID.'
...
complete -c pkill -s x -l exact --description 'Only match processes whose names (or command li… [See Man Page]'
