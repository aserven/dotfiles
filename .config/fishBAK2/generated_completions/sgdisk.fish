...
complete -c sgdisk -s E -l end-of-largest --description 'Displays the sector number of the end of the la… [See Man Page]'
complete -c sgdisk -s f -l first-in-largest --description 'Displays the sector number of the start of the … [See Man Page]'
complete -c sgdisk -s F -l first-aligned-in-largest --description 'Similar to -f (--first-in-largest), except retu… [See Man Page]'
complete -c sgdisk -s g -l mbrtogpt --description 'Convert an MBR or BSD disklabel disk to a GPT disk.'
complete -c sgdisk -s G -l randomize-guids --description 'Randomize the disk\'s GUID and all partitions\' u… [See Man Page]'
...
complete -c sgdisk -s N -l largest-new --description 'Create a new partition that fills the largest a… [See Man Page]'
complete -c sgdisk -s o -l clear --description 'Clear out all partition data.'
complete -c sgdisk -s p -l print --description 'Display basic partition summary data.'
...
complete -c sgdisk -s R -l replicate --description 'Replicate the main device\'s partition table on … [See Man Page]'
