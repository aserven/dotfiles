...
complete -c usbmuxd -s z -l enable-exit --description 'Enable "--exit" request from other instances an… [See Man Page]'
...
complete -c usbmuxd -s x -l exit --description 'Notify a running instance to exit if there are … [See Man Page]'
complete -c usbmuxd -s X -l force-exit --description 'Notify a running instance to exit even if there… [See Man Page]'
