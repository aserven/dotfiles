...
complete -c curl -s 4 -l ipv4 --description 'If curl is capable of resolving an address to m… [See Man Page]'
complete -c curl -s 6 -l ipv6 --description 'If curl is capable of resolving an address to m… [See Man Page]'
