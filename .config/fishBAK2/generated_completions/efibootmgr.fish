...
complete -c efibootmgr -s H -l acpi_hid --description 'set the ACPI HID (used with -i).'
...
complete -c efibootmgr -s U -l acpi_uid --description 'set the ACPI UID (used with -i).'
