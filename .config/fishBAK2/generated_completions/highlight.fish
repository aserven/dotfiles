...
complete -c highlight -s p -l list-langs --description 'list installed language definitions (deprecated).'
complete -c highlight -s q -l quiet --description 'supress progress info in batch mode.'
complete -c highlight -s w -l list-themes --description 'list installed themes (deprecated).'
