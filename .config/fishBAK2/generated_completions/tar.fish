...
complete -c tar -o '\\-delay\\-directory\\-restore' --description 'delay setting modification times and permission… [See Man Page]'
...
complete -c tar -o '\\-exclude\\-tag' --description 'exclude contents of directories containing FILE… [See Man Page]'
...
complete -c tar -s J --description '.'
complete -c tar -s k --description 'don\'t replace existing files when extracting, t… [See Man Page]'
...
complete -c tar -s s --description 'member arguments are listed in the same order a… [See Man Page]'
...
complete -c tar -o '\\-skip\\-old\\-files' --description 'don\'t replace existing files when extracting, s… [See Man Page]'
...
complete -c tar -o '\\-totals' --description 'print total bytes after processing the archive;… [See Man Page]'
