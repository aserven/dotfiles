...
complete -c od -s A -l address-radix --description 'output format for file offsets; RADIX is one of… [See Man Page]'
...
complete -c od -s S -l 'strings[' --description 'output strings of at least BYTES graphic chars;… [See Man Page]'
...
complete -c od -o 'w[BYTES]' -l 'width[' --description 'output BYTES bytes per output line; 32 is impli… [See Man Page]'
...
complete -c od -s c --description 'same as -t c,  select printable characters or b… [See Man Page]'
